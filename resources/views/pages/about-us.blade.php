            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src={{asset ("assets/img/instructors/ins1.jpg" )}} alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src={{asset ("assets/img/instructors/ins2.jpg" )}} alt="">
                        </div>
                        <div class="author_decs">
                            <h4>Rodney Cooper</h4>
                            <p class="profession">Sr. Faculty Data Science</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src={{asset ("assets/img/instructors/ins3.jpg" )}} alt="">
                        </div>
                        <div class="author_decs">
                            <h4>Dane Walker</h4>
                            <p class="profession">Sr. Faculty Data Science</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_instructor">
                        <div class="author">
                            <img src={{asset ("assets/img/instructors/ins4.jpg" )}} alt="">
                        </div>
                        <div class="author_decs">
                            <h4>Lena Keller</h4>
                            <p class="profession">Sr. Faculty Data Science</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center mt-100">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon1.png" )}} alt="">
                                    </div>
                                    <h4>Languages</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon2.png" )}} alt="">
                                    </div>
                                    <h4>Business</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center mt-100">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon3.png" )}} alt="">
                                    </div>
                                    <h4>Literature</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon4.png" )}} alt="">
                                    </div>
                                    <h4>Software</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center mt--100">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon5.png" )}} alt="">
                                    </div>
                                    <h4>Design</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon6.png" )}} alt="">
                                    </div>
                                    <h4>Development</h4>
                                </div>
                            </div>
                            ...
                            <div class="offset-lg-4 col-lg-4 col-md-4 col-sm-6 col-12 text-center mt--100">
                                <div class="single_department">
                                    <div class="dpmt_icon">
                                        <img src={{asset ("assets/img/dpmt/icon7.png" )}} alt="">
                                    </div>
                                    <h4>Development</h4>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon1.png" )}} alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon2.png" )}} alt="">
                        </div>
                        <h4>25000+ Courses</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon3.png" )}} alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon4.png" )}} alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon5.png" )}} alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        <div class="f_icon">
                            <img src={{asset ("assets/img/f-icons/icon6.png" )}} alt="">
                        </div>
                        <h4>Live Support</h4>
                        <p>Lorem ipsum dolor sit amet consec tetur adipis icing elit, sed do eiusmod tempor incididunt
                            labore dolor sit
                    ...
                    <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                        <div class="owl-thumb-item">
                            <div class="position-relative">
                                <img class="img-fluid" src={{asset ("assets/img/testimonial/t1.jpg" )}} alt="">
                            </div>
                            <div class="overlay-grad"></div>
                        </div>
                        <div class="owl-thumb-item">
                            <div class="position-relative">
                                <img class="img-fluid" src={{asset ("assets/img/testimonial/t2.jpg" )}} alt="">
                            </div>
                            <div class="overlay-grad"></div>
                        </div>
                        <div class="owl-thumb-item">
                            <div class="position-relative">
                                <img class="img-fluid" src={{asset ("assets/img/testimonial/t3.jpg" )}} alt="">
                            </div>
                            <div class="overlay-grad"></div>
                        </div>
                        <div class="owl-thumb-item">
                            <div class="position-relative">
                                <img class="img-fluid" src={{asset ("assets/img/testimonial/t4.jpg" )}} alt="">
                            </div>
                            <div class="overlay-grad"></div>
                        </div>
                    </div>
